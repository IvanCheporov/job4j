 ...
 * @since 24.04.2019
 */
public class TrackerSingleEnumEagerTest {
    @Test
    public void whenCheckSingletonForEnumEager() {
        TrackerSingleEnumEager trackerFirst = TrackerSingleEnumEager.INSTANCE;
        TrackerSingleEnumEager trackerSecond = TrackerSingleEnumEager.INSTANCE;
